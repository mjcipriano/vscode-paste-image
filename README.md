...
Release tags use the package version with a leading `v`, for example `v1.0.4-internal.4`.
...
In VS Code, open the Extensions view, choose `...`, select `Install from VSIX...`, and pick the generated `paste-image-internal-1.0.4-internal.4.vsix` file.

You can also install it from the command line:

```
code --install-extension paste-image-internal-1.0.4-internal.4.vsix
```
